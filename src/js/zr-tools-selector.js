 ...
 */
   ...
   //
    ...
    $.prototype = {
        ...
        html:function(html){
            var elem = this[0] || {}
            if($.isUndefined(html) || $.isNull(html)){
    ...
    $.ready = function(fn){
        if(document.addEventListener){//兼容非IE
            document.addEventListener("DOMContentLoaded",domReadyFn,false);
        ...
        function domReadyFn(){
            //注销事件，避免反复触发
            document.removeEventListener("DOMContentLoaded",domReadyFn,false);
            fn();//调用参数函数
        }
